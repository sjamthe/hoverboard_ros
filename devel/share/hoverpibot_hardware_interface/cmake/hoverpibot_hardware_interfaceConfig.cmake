...
if(NOT "/home/ubuntu/catkin_ws_sj/src/hoverpibot_hardware_interface/include " STREQUAL " ")
  set(hoverpibot_hardware_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws_sj/src/hoverpibot_hardware_interface/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hoverpibot_hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws_sj/src/hoverpibot_hardware_interface/${idir}'.  ${_report}")
    endif()
